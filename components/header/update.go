...
func activeHelp(focus enums.FocusArea) string {
	...
	case enums.FocusAmount:
		return "Amount • type value • h/l assets • p recipients • a add contact • s simulate • c contract • S send"
	...
	default:
		return "hjkl move • t assets • x transactions • p recipients • a add contact • s simulate • c contract • S send"
	}
}
